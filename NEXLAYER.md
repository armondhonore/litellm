...
**Live:** [https://relaxed-weasel-litellm.cloud.nexlayer.ai](https://relaxed-weasel-litellm.cloud.nexlayer.ai)  

**Runtime:**  · **Port:** auto-detected · **Deploy branch:** litellm_internal_staging

---

## How this deployment works

**litellm** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
platform where every push to `litellm_internal_staging` triggers a fully automated build-and-deploy
...
Triggers on:
- **Push** to `litellm_internal_staging` → production redeploy
...
> `<podName>.pod:<port>` syntax. CI/CD runs on push to `litellm_internal_staging`."*
